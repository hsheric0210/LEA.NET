...
public abstract class BlockCipherMode
{
	...
	/// <param name="iv">
	///            초기화 벡터</param>
	public abstract void Init(OperatingMode mode, ReadOnlySpan<byte> key, ReadOnlySpan<byte> iv);
	...
	/// <param name="padding">
	///            패딩 알고리즘 객체</param>
	public abstract void SetPadding(PaddingBase padding);
	...
	public abstract ReadOnlySpan<byte> Update(ReadOnlySpan<byte> bytes);
	...
	public abstract ReadOnlySpan<byte> DoFinal(ReadOnlySpan<byte> bytes);
