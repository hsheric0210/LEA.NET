namespace LEA
{
	...
	public abstract class BlockCipherMode
	{
		...
		/// <param name="key">
		///            암호화 키</param>
		public abstract void Init(BlockCipher.Mode mode, byte[] key);
		/// <summary>
		...
		/// <param name="iv">
		///            초기화 벡터</param>
		public abstract void Init(BlockCipher.Mode mode, byte[] key, byte[] iv);
		/// <summary>
		...
		public abstract byte[] DoFinal(byte[] message);
		/// <summary>
		/// 암/복호화 최종단계 수행
		/// </summary>
		/// <returns>암호문 혹은 평문의 마지막 부분</returns>
