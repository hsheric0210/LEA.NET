...
public abstract class PaddingBase
{
    ...
    public abstract ReadOnlySpan<byte> Pad(ReadOnlySpan<byte> unpadded);
    ...
    /// <param name="offset">
    ///            메시지 길이</param>
    public abstract void Pad(Span<byte> unpadded, int offset);
    ...
    public abstract ReadOnlySpan<byte> Unpad(ReadOnlySpan<byte> padded);
    ...
    public abstract int GetPadCount(ReadOnlySpan<byte> padded);
}