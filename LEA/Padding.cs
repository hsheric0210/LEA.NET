namespace LEA
{
	...
	public abstract class Padding
	{
		...
		public abstract byte[] Pad(byte[] inBytes);
		/// <summary>
		/// 패딩 추가
		/// </summary>
		/// <param name="in">
		...
		/// <param name="inOffset">
		///            메시지 길이</param>
		public abstract void Pad(byte[] inBytes, int inOffset);
		/// <summary>
		/// 패딩 제거
		/// </summary>
		/// <param name="in">
		...
		public abstract byte[] Unpad(byte[] inBytes);
		/// <summary>
		/// 패딩 길이 계산
		/// </summary>
		/// <param name="in">
		...
		public abstract int GetPadCount(byte[] inBytes);
	}
}