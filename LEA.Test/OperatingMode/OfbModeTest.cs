...
Before:
			var cipher = new Symmetric.Lea.Ofb();
After:
			var cipher = new LEA.Lea.Ofb();
*/
...
*/
			...
			{
				var testvector = lea256OfbTestVectors[i];
...
*/
			...
			{
				var testvector = lea192OfbTestVectors[i];
...
*/
			...
			{
				var testvector = lea128OfbTestVectors[i];
