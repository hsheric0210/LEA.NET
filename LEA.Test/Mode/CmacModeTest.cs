...
public class CmacModeTest
{
    ...
    private readonly TestVectorMac[] Lea128CmacTestVectors =
    {
        ...
        new TestVectorMac
        {
            Key = new byte[] { 0xBA, 0x6A, 0x53, 0x98, 0xF9, 0xBC, 0x73, 0x3B, 0x4E, 0x42, 0x8C, 0x32, 0xE2, 0x56, 0x1F, 0x4C },    Data = new byte[] { 0x5C, 0xD2, 0x2F, 0xCF, 0xF7, 0xD2, 0xF6, 0x5F, 0xD8, 0xBC, 0xD7, 0x22, 0x9E, 0x7E, 0x94, 0x22, 0x3A, 0x17, 0xC1, 0xF3, 0x1, 0x59, 0x78, 0x95 },
            Mac = new byte[] { 0x5B, 0x96, 0xD3, 0xB0, 0xC6, 0x11, 0x2A, 0xF7, 0xD4, 0xDA, 0xD4, 0x29, 0xB5, 0x44, 0x4E, 0x26 },},
        new TestVectorMac
        {
            Key = new byte[] { 0xFF, 0xED, 0x4F, 0x9B, 0x8F, 0x97, 0x87, 0x8D, 0x29, 0xBB, 0x86, 0x8C, 0x7A, 0x21, 0x87, 0x34 },    Data = new byte[] { 0xBA, 0xF5, 0x91, 0xC7, 0x3A, 0x12, 0xA5, 0x87, 0x3C, 0x80, 0x3C, 0x63, 0x8, 0x3A, 0xF1, 0xD6, 0x3C, 0x35, 0x7A, 0xD, 0x64, 0x9F, 0xDC, 0x48, 0xCA, 0x64, 0xDF, 0x82, 0x90, 0xF7, 0xC0, 0x54 },
            Mac = new byte[] { 0x43, 0x15, 0x6D, 0xD7, 0x86, 0x74, 0xA3, 0x34, 0x13, 0x7A, 0x36, 0x71, 0xEE, 0xCA, 0x60, 0xE },
        },
        new TestVectorMac
        {
            Key = new byte[] { 0xFB, 0x4F, 0x27, 0x17, 0x12, 0x30, 0x58, 0x49, 0x68, 0xAB, 0xAD, 0x31, 0x36, 0xE8, 0x44, 0xC6 },    Data = new byte[] { 0xAC, 0x23, 0xF5, 0xCE, 0x89, 0xF5, 0x87, 0x43, 0xEA, 0xD5, 0x23, 0xFA, 0x5F, 0xDE, 0x8, 0x87, 0x44, 0xD3, 0x81, 0x5B, 0x4F, 0x60, 0x14, 0x2F, 0x65, 0xA2, 0xFD, 0xA6, 0xB2, 0xEA, 0xDB, 0x2D, 0xF8, 0xBE, 0xA8, 0x26, 0x27, 0x21, 0xEE, 0x47 },
        ...
        new TestVectorMac
        {
            Key = new byte[] { 0xC9, 0x22, 0x7A, 0x3E, 0xBE, 0x44, 0x4B, 0x5F, 0xDD, 0xA5, 0x38, 0xAD, 0xF0, 0xAE, 0x8F, 0x8F },    Data = new byte[] { 0xD6, 0x9B, 0x30, 0xB5, 0x8E, 0x3A, 0x41, 0xFB, 0x91, 0xEF, 0x22, 0x90, 0x65, 0xFC, 0xA3, 0x57, 0x6F, 0xFF, 0x75, 0x8D, 0x9, 0xBC, 0xDF, 0xAD, 0xD4, 0x1D, 0xB2, 0x90, 0x4F, 0x77, 0x7F, 0xD9, 0xA9, 0xF, 0x7, 0x90, 0xD4, 0xDD, 0xF3, 0xD, 0xDB, 0x90, 0xC6, 0x18, 0x75, 0xD2, 0xF, 0x4E, 0xDA, 0xCC, 0xE3, 0xC7, 0xD5, 0xED, 0x8A, 0xF5 },
            Mac = new byte[] { 0x25, 0x46, 0x7C, 0x84, 0x10, 0xF6, 0xF9, 0xB2, 0x98, 0x88, 0xB1, 0xEE, 0x92, 0xA7, 0x57, 0xC4 },},
        new TestVectorMac
        {
            Key = new byte[] { 0x1B, 0xE7, 0x79, 0xCF, 0xDB, 0xFB, 0x80, 0x2F, 0x96, 0x77, 0x45, 0x79, 0x31, 0x7D, 0xF1, 0x7E },    Data = new byte[] { 0x49, 0x5, 0x29, 0xA0, 0xC6, 0x25, 0x40, 0x36, 0xB3, 0x91, 0xAB, 0x32, 0x4D, 0x5E, 0xB5, 0x1, 0x59, 0xB, 0x74, 0xB2, 0xBB, 0xC1, 0xFB, 0x5B, 0x45, 0xDA, 0xD1, 0xB8, 0xCD, 0xA1, 0xA2, 0x16, 0x82, 0x58, 0x35, 0x6F, 0x80, 0x80, 0x9E, 0xD7, 0xA1, 0x54, 0xB5, 0x16, 0x96, 0x97, 0xC6, 0x97, 0x37, 0x8F, 0x8A, 0x81, 0x18, 0x52, 0x56, 0x23, 0x5D, 0x40, 0x93, 0x95, 0xCF, 0xD1, 0x6E, 0x9C },
            Mac = new byte[] { 0x15, 0x8B, 0x4F, 0xA5, 0xAA, 0x68, 0x15, 0x2B, 0xF1, 0x1, 0xFB, 0xB3, 0x4, 0x8A, 0x7E, 0x16 },
        },
        new TestVectorMac
        {
            Key = new byte[] { 0x2F, 0x91, 0xD0, 0xCF, 0xCA, 0x68, 0x91, 0xF8, 0x4D, 0x1F, 0xE9, 0xBD, 0xDB, 0x20, 0x27, 0x80 },    Data = new byte[] { 0x5D, 0x7D, 0xA5, 0x83, 0x19, 0x34, 0xFB, 0x50, 0x87, 0xB2, 0x73, 0x58, 0x5F, 0x95, 0xBD, 0xDA, 0xF7, 0xB6, 0xE4, 0x6, 0xCC, 0x67, 0x81, 0x63, 0x5E, 0xF9, 0x2F, 0x6E, 0x42, 0x82, 0x3E, 0x84, 0x72, 0xDC, 0xAC, 0x1, 0xE7, 0xF1, 0x50, 0xAA, 0x6A, 0x36, 0x59, 0x48, 0xA7, 0x76, 0xF7, 0x96, 0x83, 0xD1, 0x58, 0x5D, 0xAF, 0x4, 0xD6, 0xDE, 0x7D, 0xEB, 0x6F, 0x70, 0xF3, 0x44, 0x75, 0x6A, 0x1F, 0xB5, 0x86, 0x43, 0xA9, 0x11, 0xBF, 0xF8 },
